...
Engineering for Humanity in Morocco | 2019
...
<figure>
  <img src="{{ site.url }}/assets/img/piping/abney.PNG" alt="abney" height="65%" width="65%"/>
...
<figure>
  <img src="{{ site.url }}/assets/img/piping/topography.PNG" alt="abney" height="75%" width="75%"/>
...
After finding out that service for solar pumps was nearly non-existent, we decided to switch to using a solar controller for an electric pump. After tanks was complete, our entire team focused our efforts to build the solar rack. After installing the panels and connecting the solar controller to the pump, we were near ready to fully test our system.
