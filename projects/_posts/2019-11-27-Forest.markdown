...
<figure>
  <img src="{{site.url}}/assets/img/xylo/0.PNG" alt="my alt text"/>
...
<figure>
  <img src="{{site.url}}/assets/img/xylo/1.png" alt="my alt text" height="50%" width="50%"/>
...
<figure>
  <img src="{{site.url}}/assets/img/xylo/2.jpg" alt="test" height="50%" width="50%"/>
  <figcaption>Kalara (middle), a smallholder farmer, and her two sons who work as daily wage labourers.</figcaption>
</figure>

<figure>
  <img src="{{site.url}}/assets/img/xylo/3.PNG" alt="my alt text"/>
